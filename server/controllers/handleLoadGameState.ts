...
export const handleLoadGameState = async (req: Request, res: Response) => {
  try {
    ...
    const { checkpoints, startTimestamp } = visitorProgress;
...
const parseEnvJson = (envVar: string | undefined) => {
  try {
